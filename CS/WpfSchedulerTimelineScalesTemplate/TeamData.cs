...
namespace WpfSchedulerTimelineScalesTemplate
{
    ...
    public static class TeamData
    {
        static TeamData()
        {
            ...
            Employees = new List<Employee>();
            Employees.Add(new Employee() { FirstName = "Andrew", LastName = "Glover" });
            Employees.Add(new Employee() { FirstName = "Mark", LastName = "Oliver" });
            Employees.Add(new Employee() { FirstName = "John", LastName = "Heart" });
            Employees.Add(new Employee() { FirstName = "Olivia", LastName = "Peyton" });
            Employees.Add(new Employee() { FirstName = "Sandra", LastName = "Johnson" });
            Employees.Add(new Employee() { FirstName = "Amelia", LastName = "Harper" });
